...
$sql = "SELECT * FROM ticket WHERE categorie = 'Attente'"; // Personnalisez la requête selon votre structure de base de données
$stmt = $db->prepare($sql);
$stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="./scss/attente/base_attente.css">
    <link rel="stylesheet" href="./scss/attente/layout/attente_style.scss">
    <link rel="stylesheet" href="./scss/attente/layout/icons.scss">
    <link rel="stylesheet" href="./scss/attente/layout/box.css">
