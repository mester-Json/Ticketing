...
$sql = "SELECT * FROM ticket WHERE categorie = 'Archive'"; // Personnalisez la requête selon votre structure de base de données
$stmt = $db->prepare($sql);
$stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="./scss/index/footer.css">
